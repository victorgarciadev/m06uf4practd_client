...
public class JocController implements Initializable {
     ...
     * 
     * @param graella GridPane que conté les caselles de les lletres a endevinar.
     * @param columnes valor enter que defineix el nombre de lletres a endevinar.
     * @param files valor enter que determina el nombre d'intents per endevinar la paraula amagada.
     * 
     * @author Txell Llanas
     */
    ...
    /**
     * Mètode per crear el teclat de forma dinàmica, segons les lletres designades
     * dins una matriu de Strings per a cada fila del teclat.
     * 
